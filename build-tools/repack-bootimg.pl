...
system ("mkbootimg --cmdline 'console=ttyHSL0,115200,n8 androidboot.hardware=dlxj user_debug=31' --kernel $ARGV[0] --ramdisk ramdisk-repack.cpio.gz --base 0x80600000 --ramdiskaddr 0x81a08000 -o $ARGV[2]");
